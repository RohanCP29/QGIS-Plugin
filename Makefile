...
SOURCES = \
	__init__.py \
	test_rohan.py test_rohan_dialog.py

PLUGINNAME = test_rohan

PY_FILES = \
	__init__.py \
	test_rohan.py test_rohan_dialog.py

UI_FILES = test_rohan_dialog_base.ui
...
QGISDIR=C:\Users\patil\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
